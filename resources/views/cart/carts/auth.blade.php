            ...
            <div class="w-full lg:flex px-1">
                <div class="w-full lg:w-9/12 mb-3 space-y-2">
                    @foreach($products as $product)
                        <div class="border rounded bg-gray-50 hover:shadow">
                            <div class="mb-2 flex justify-between">
                                <div class="mt-2">
                                            ...
                                            <x-form action="{{ route('cart.update', $product->id) }}" method="POST">
                                                ...
                                                <div class="flex items-center space-x-1 lg:mr-6 mr-2">
                                                    ...
                                                    <button class="border rounded-full bg-gray-50 hover:bg-white"
                                                            type="submit"
                                                            name="action" value="increase_quantity">
                                                    ...
                                                    <input class="w-10 border rounded text-center font-bold "
                                                           name="quantity" type="number"
                                                           min="1" max="99" value="{{ $product->pivot->quantity }}">
                                                    <button class="border rounded-full bg-gray-50 hover:bg-white"
                                                            type="submit"
                                                            name="action" value="decrease_quantity">
                                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none"
                                                             viewBox="0 0 24 24" stroke-width="1.5"
                                                             stroke="currentColor" class="w-6 h-6">
                                                            <path stroke-linecap="round" stroke-linejoin="round"
